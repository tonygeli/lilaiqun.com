...
(1,3,1,'admin','你可能忽略掉的后台小功能（一）','color:rgb(247, 184, 36);font-weight:normal;','','你可能忽略掉的后台小功能（一）','你可能忽略掉的后台小功能（一）','<p>刷新：刷新当前标签页</p><p>关闭当前：关闭当前标签页</p><p>关闭其他：除选中的标签页外，关闭其他全部标签页</p><p>关闭所有：关闭全部标签页</p>','0',2,1,0,'',0,0,240,1499760262,1504516593,'CLTPHP','http://www.cltphp.com/'),
...
(11,5,1,'admin','CLTPHP4.3版本更新','color:rgb(255, 87, 34);font-weight:bold;','','CLTPHP4.3版本更新,CLTPHP,CLTPHP内容管理系统','CLTPHP4.3版本更新,CLTPHP,CLTPHP内容管理系统','<p>更新内容</p><p>1.后台模型建立重构</p><p>2.新增文件上传</p><p>3.更改标题样式和缩略图数据库存放方式</p><p>4.后台文章栏目标题样式添加</p><p>5.修改部分bug，删减了系统冗余内容</p><p><b><i>注意：本次修改重构了模型，4.2及以前版本不可直接覆盖代码</i></b></p><p>推荐环境：apache2.4+php5.5(以上)+mysql5.0(以上)</p><p>开发环境：phpStudy 2016 &nbsp;php5.5.38</p>','0',1,1,0,'',0,0,757,1499828638,1500014573,'CLTPHP','http://www.cltphp.com/'),
...
(21,5,1,'admin','CLTPHP4.5发布','color:rgb(0, 153, 102);font-weight:bold;','','CLTPHP4.5发布','CLTPHP4.5发布','<p>1.更新权限功能</p><p>2.增加微信关注回复和默认回复</p><p>3.增加后台页面过度效果</p><p>4.后台部分功能代码优化</p>','0',2,1,0,'',0,0,152,1502067980,1502422491,'CLTPHP','http://www.cltphp.com/'),
...
(23,3,1,'admin','清除缓存和添加字段的错误修正方法','color:;font-weight:normal;','','清除缓存和添加字段的错误修正方法','清除缓存和添加字段的错误修正方法','<p><span>问题：</span></p><pre>Deprecated: Automatically populating $HTTP_RAW_POST_DATA is deprecated and will be removed in a future version. To avoid this warning set \'always_populate_raw_post_data\' to \'-1\' in php.ini and use the php://input stream instead. in Unknown on line 0</pre><p><span><br></span></p><p><span>修正方法：</span></p><p>去掉<span>php.in配置文件always_populate_raw_post_data前面的分号</span></p><p><span><br></span></p><p><span><br></span></p>','0',0,1,0,'',0,1,68,1502761583,1502761875,'CLTPHP','http://www.cltphp.com/'),
(25,5,1,'admin','CLTPHP手册更新自定义标签','color:;font-weight:normal;','','CLTPHP手册更新自定义标签','CLTPHP手册更新自定义标签','<p>CLTPHP手册更新自定义标签，文档详细讲述了 {clt:list}{/clt:list} 和 {clt:info}{/clt:info} 两个标签的参数和调用方法。</p>','0',1,1,0,'',0,0,93,1503365502,0,'CLTPHP','http://www.cltphp.com/');
...
(3,'产品服务','services','',0,2,'article','0','3',0,'产品服务-CLTPHP','产品服务,CLTPHP,CLTPHP内容管理系统','产品服务',1,0,1,0,'',0,'','','',15,'1,2,3',0,0),
...
(83,1,'ceshi','ceshi','',1,0,0,'defaul','','ceshi','text','array (\n  \'default\' => \'\',\n  \'ispassword\' => \'0\',\n  \'fieldtype\' => \'varchar\',\n)',0,'',0,1,0);
...
insert  into `clt_page`(`id`,`title`,`title_style`,`thumb`,`hits`,`status`,`userid`,`username`,`listorder`,`createtime`,`updatetime`,`lang`,`content`,`ceshi`) values 
...
(1,4,1,'admin','模型列表','模型列表','展示网站内容模型，模型是CLTPHP的核心之一。','<p>展示网站内容模型，模型是CLTPHP的核心之一。</p>','0',0,1,0,'',0,1,0,1499761915,1504518767,'/uploads/20170904/f5a33a284f8036c3a086f2829f98599b.png','1'),
...
(1,'CLTPHP','http://www.cltphp.com/','CLTPHP','CLTPHP,CLTPHP内容管理系统,php','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。','陕ICP备15008093号-3','2015-2020','西安市雁塔区','18792402119','1109305987@qq.com','/uploads/20170904/9f04d8be2a05d926bc3e328eded02378.png');
...
(2595,'1109305987@qq.com','e10adc3949ba59abbe56e057f20f883e',NULL,1,0,1504510472,0,'','','18792402229',0,'',NULL,NULL,'/uploads/20170904/c9a67df7424692b8ce783c45f9bcd40a.jpg',3,37,410,0,'chichu',1,0,'b1dbf9f02a1d638f69fd017843140717','不要因为走得太远，就忘了当初为什么出发。','hide');
...
/*Table structure for table `clt_wx_news` */
...
/*Data for the table `clt_wx_news` */
